                ...
                orders.map((o) => (
                  <tr key={o.id} className="hover:bg-[#1a1a1a]/50 transition-colors">
                    <td className="px-6 py-4 uppercase text-xs">
                      <p className="text-[#d4af37] font-medium tracking-widest">#{o.id.slice(0,8)}</p>
                    ...
                    <td className="px-6 py-4 font-playfair text-lg text-[#d4af37] tracking-wider">${o.total}</td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4 text-right">
                      <button className="text-xs uppercase tracking-widest text-[#d4af37] hover:text-white transition-colors">Ver Detalle</button>
                    </td>
                  </tr>
                ))
              )}
